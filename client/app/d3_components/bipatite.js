var bP={};	
var b=50, bb=300, height=600, buffMargin=1, minHeight=14;
var c1=[-220, 80], c2=[-50, 260], c3=[-10, 300]; //Column positions of labels.
var colors =["#3366CC", "#DC3912",  "#FF9900","#109618", "#990099", "#0099C6","#AA9900", "BB3300", "#DEDEDE", 
			"#ABABAB", "#123456",  "#621345", "#620045", "#001100", "#11B6ED", "#4811ED", "#AD2F4C", "#EDD311",
			"#0CEEF2", "#68F79C", "#F76E5C", "#470FF2", "#3DF2E9", "#9AF5D4", "#946766", "#CBF59F", "#740EC7",
			"#1796B3", "#F7A8E0", "#621345"];
...
function drawPart(data, id, p){
	...
	mainbar.append("text").attr("class","barlabel")
		...
		.text(function(d,i){ return data.keys[p][i].slice( 0, 19 );})
...
window.drawBipatite = function( myData, target ) {
	var width = 1000, height = 1000, margin ={b:0, t:40, l: 300, r: 0 };
	...
	var data = [ 
		...
		{data:bP.partData( myData,3 ), id:'Sales', header:["Name","장르", "Movit"]}
	];

	bP.draw(data, svg);
};

// movie, genre, moviecount, genrecount
//['Elite','WV',368,3]

window.makeBipatiteData = function ( list, targetArrayName ) {
	var newList = [];
	list.forEach( function ( elem, index, array ) {
		_.each( elem[ targetArrayName ], function( genre ) {
			var newItem = [ elem.name, genre, 1, 1 ];
